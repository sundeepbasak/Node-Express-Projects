...
> when using express-async-errors(a npm package), we dont need to individually add try-catch statement to every controller func, it applies it automatically and handle the errors

#### morgan
morgan is a Node. js and Express middleware to log HTTP requests and errors, and simplifies the process, and is basically used as a logger.
